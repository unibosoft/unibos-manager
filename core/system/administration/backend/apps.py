"""Administration Django App Configuration - UNIBOS Module Integration"""
...
class AdministrationConfig(AppConfig):
    ...
    name = 'core.system.administration.backend'
    ...
    def _initialize_module(self):
        try:
            ...
            self.unibos_module = UnibosModule('administration')
            import logging
            logging.getLogger(__name__).info(f"✓ Initialized UNIBOS module: administration v{self.unibos_module.manifest.get('version')}")
            self.unibos_module.get_storage_path('audit/')
