"""
Authentication Django App Configuration
...
class AuthenticationConfig(AppConfig):
    ...
    def _initialize_module(self):
        ...
        try:
            ...
            # Initialize module
            self.unibos_module = UnibosModule('authentication')

            # Log initialization
            import logging
            logger = logging.getLogger(__name__)
            logger.info(f"✓ Initialized UNIBOS module: authentication v{self.unibos_module.manifest.get('version')}")
